...
export class WalletsController {
  ...
  @Get()
  @ApiOkResponse({description: "The list of all wallets", type: Wallet, isArray: true})
  findAll() {
  ...
  @Post()
  @ApiCreatedResponse({description: "The wallet was succefuly created", type: Wallet})
  create(@Body(ValidationPipe) createWalletDto: CreateWalletDto) {
    return this.walletsService.create(createWalletDto);
  }

  @Patch('deposit/:id')
  @ApiOkResponse({description: "The deposit was succefully done", type: Wallet})
  ...
  @Patch('withdraw/:id')
  @ApiOkResponse({description: "The withdraw was succefully done", type: Wallet})
  ...
  @Patch(':id')
  @ApiOkResponse({description: "The update was succefully done", type: Wallet})
