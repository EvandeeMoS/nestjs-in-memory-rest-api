...
export class UsersController {
  ...
  @Get()
  @ApiOkResponse({isArray: true, type: User, description: "List of all users"})
  findAll() {
    return this.usersService.findAll();
  }

  @Get(':id')
  @ApiOkResponse({type: User, description: "List the user with the passed Id"})
  @ApiNotFoundResponse({description: "Not found. A user with the passed id doesn't exist"})
